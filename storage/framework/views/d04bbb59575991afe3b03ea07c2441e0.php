                ...
                <table id="datatablesSimple" class="table-striped fs-6">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('editar-categoria')): ?>
                                                    <li><a class="dropdown-item"
                                                            href="<?php echo e(route('categorias.edit', ['categoria' => $categoria])); ?>">Editar</a>
                                                    </li>
                                                <?php endif; ?>
                                            </ul>
                                        </div>
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('eliminar-categoria')): ?>
                                                <?php if($categoria->caracteristica->estado == 1): ?>
                                                    <button title="Eliminar" data-bs-toggle="modal"
                                                        data-bs-target="#confirmModal-<?php echo e($categoria->id); ?>"
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="confirmModal-<?php echo e($categoria->id); ?>" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form action="<?php echo e(route('categorias.destroy', ['categoria' => $categoria->id])); ?>"
                                                method="post">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\julia\OneDrive\Escritorio\ProyectoFinal\resources\views/categoria/index.blade.php ENDPATH**/ ?>