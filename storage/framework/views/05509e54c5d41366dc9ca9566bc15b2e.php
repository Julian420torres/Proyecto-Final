        ...
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ver-menu')): ?>
                    <a class="nav-link" href="<?php echo e(route('menus.index')); ?>">
...
<?php /**PATH C:\Users\julia\OneDrive\Escritorio\correcion\Proyecto-Final\resources\views/components/navigation-menu.blade.php ENDPATH**/ ?>