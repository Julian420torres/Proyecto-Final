                ...
                <table id="datatablesSimple" class="table table-striped fs-6">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $productos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <td>
                                    <?php $__currentLoopData = $item->categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="container" style="font-size: small;">
                                            <div class="row">
                                                <span
                                                    class="m-1 rounded-pill p-1 bg-secondary text-white text-center"><?php echo e($category->caracteristica->nombre); ?></span>
                                            </div>
                                        </div>
                                            ...
                                            <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('editar-producto')): ?>
                                                    <li><a class="dropdown-item"
                                                            href="<?php echo e(route('productos.edit', ['producto' => $item])); ?>">Editar</a>
                                                    </li>
                                                <?php endif; ?>
                                                <!----Ver-producto--->
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('ver-producto')): ?>
                                                    <li>
                                                        <a class="dropdown-item" role="button" data-bs-toggle="modal"
                                                            data-bs-target="#verModal-<?php echo e($item->id); ?>">Ver</a>
                                                    </li>
                                                <?php endif; ?>
                                            </ul>
                                        </div>
                            ...
                            <!-- Modal -->
                            <div class="modal fade" id="verModal-<?php echo e($item->id); ?>" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-dialog-scrollable">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-12">
                                                    <p><span class="fw-bolder">Descripción: </span><?php echo e($item->descripcion); ?>

                                                    </p>
                                                </div>
                                                <div class="col-12">
                                                    <p><span class="fw-bolder">Fecha de vencimiento:
                                                        </span><?php echo e($item->fecha_vencimiento == '' ? 'No tiene' : $item->fecha_vencimiento); ?>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                data-bs-dismiss="modal">Cerrar</button>
                                            <form action="<?php echo e(route('productos.destroy', ['producto' => $item->id])); ?>"
                                                method="post">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\julia\OneDrive\Escritorio\ProyectoFinal\resources\views/producto/index.blade.php ENDPATH**/ ?>