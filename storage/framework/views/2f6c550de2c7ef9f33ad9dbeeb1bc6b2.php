                                            ...
                                            <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('editar-cliente')): ?>
                                                    <li><a class="dropdown-item"
                                                            href="<?php echo e(route('clientes.edit', ['cliente' => $item])); ?>">Editar</a>
                                                    </li>
                                                <?php endif; ?>
                                            </ul>
                                        </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form
                                                action="<?php echo e(route('clientes.destroy', ['cliente' => $item->persona->id])); ?>"
                                                method="post">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\julia\OneDrive\Escritorio\ProyectoFinal\resources\views/cliente/index.blade.php ENDPATH**/ ?>