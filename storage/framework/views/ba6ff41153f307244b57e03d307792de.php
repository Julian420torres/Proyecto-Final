                                            ...
                                            <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('editar-user')): ?>
                                                    <li><a class="dropdown-item"
                                                            href="<?php echo e(route('users.edit', ['user' => $item])); ?>">Editar</a></li>
                                                <?php endif; ?>
                                            </ul>
                                        </div>
                                        <div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\julia\OneDrive\Escritorio\ProyectoFinal\resources\views/user/index.blade.php ENDPATH**/ ?>